...
function getKeywordCompletions(replaceRange: Range): CompletionItem[] {
    return [
        ...
        },
        {
            ...
            textEdit: TextEdit.replace(replaceRange, 'now'),
            insertTextFormat: InsertTextFormat.PlainText,
            sortText: '309a',
        },
        {
            ...
            textEdit: TextEdit.replace(replaceRange, '@[${1:Start}, ${2:End}]'),
            insertTextFormat: InsertTextFormat.Snippet,
            sortText: '309b',
        },
        {
            ...
            textEdit: TextEdit.replace(replaceRange, '<-[${1:0s}, ${2:duration}] ${3:predicate}(${4:args})'),
            insertTextFormat: InsertTextFormat.Snippet,
            sortText: '309c',
        },
        {
