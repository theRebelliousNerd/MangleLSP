...
function getKeywordCompletions(replaceRange) {
    return [
        ...
        },
        {
            ...
            textEdit: node_1.TextEdit.replace(replaceRange, 'now'),
            insertTextFormat: node_1.InsertTextFormat.PlainText,
            sortText: '309a',
        },
        {
            ...
            textEdit: node_1.TextEdit.replace(replaceRange, '@[${1:Start}, ${2:End}]'),
            insertTextFormat: node_1.InsertTextFormat.Snippet,
            sortText: '309b',
        },
        {
            ...
            textEdit: node_1.TextEdit.replace(replaceRange, '<-[${1:0s}, ${2:duration}] ${3:predicate}(${4:args})'),
            insertTextFormat: node_1.InsertTextFormat.Snippet,
            sortText: '309c',
        },
        {
