...
exports.checkStratification = checkStratification;
exports.checkUnboundedRecursion = checkUnboundedRecursion;
exports.checkCartesianExplosion = checkCartesianExplosion;
...
function checkUnboundedRecursion(unit) {
    ...
    const predicateClauses = new Map();
    for (const clause of unit.clauses) {
